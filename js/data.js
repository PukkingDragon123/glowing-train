...
/* ============================================================
   SHELL & DEBT — data.js
   All content: the crew, the guns, the belt, the questions,
   and every number the case is tuned on.
   ============================================================ */
...
const ANTES = 8;              // rungs of his organisation, bottom to top
...
/* item rarity weights per lead: common, uncommon, rare, legendary */
...
const BOSSES = [
  ...
  { id: 'cage', traits: ['patch'], name: 'WARDEN WART', hp: 6, aggro: 0.55,
    ...
    desc: 'Everything on the table stays on the table: your BELT is locked this duel.' },
